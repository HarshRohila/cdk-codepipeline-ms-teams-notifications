...
describe('create-ms-team-notification | Function', () => {
  it('runs', async () => {
    ...
    expect(response).toStrictEqual({ body: '{"message":"Successful lambda invocation"}', statusCode: 200 });
  });
});